...
from luma_cli.core.output import print_error, print_json, print_success, print_task_result
...
def tasks_batch(
    ...
    Examples:
      ...
      luma tasks abc123 def456 ghi789
    """
    client = get_client(ctx.obj.get("token"))
    try:
...
def wait(
    ...
    Examples:
      ...
      luma wait abc123 --interval 10 --timeout 300
    """
    client = get_client(ctx.obj.get("token"))
    elapsed = 0
