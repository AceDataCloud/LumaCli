# Copilot Instructions for LumaCli
...
2. **Compare parameters** — CLI command parameters in `luma_cli/commands/` should match the corresponding OpenAPI endpoint's request body schema.
...
4. **Update client** — If API endpoints change, update `luma_cli/core/client.py` accordingly.
